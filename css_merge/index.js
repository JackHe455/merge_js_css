...
class merge_css {
     ...
     * @param tmp_css_json_dir {String} 中间json存储目录路径
     */
    constructor(html_path_list,extract_tag,output_path,tmp_css_json_dir){
        this.html_path_list=html_path_list;
        this.extract_tag=extract_tag;
        this.output_path=output_path;
        this.tmp_css_json_dir=tmp_css_json_dir;  //暂存的json的路径
    }
    ...
    run(){
        this.html_path_list.forEach(item=>{
            ...
            let json_path=path.join(this.tmp_css_json_dir,file_name+'_'+md5_result+'.json');
        ...
        console.info("合并html的css成功完成！");
    }
}

module.exports=merge_css;